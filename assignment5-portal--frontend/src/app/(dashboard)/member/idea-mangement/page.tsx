...
import IdeaTable from "@/components/modules/dashboard/member/idea-management/ideaTable";
import { getAllCategory } from "@/service/idea.catetogory.service";
import { getAllRoleWiseIdeas } from "@/service/idea.service";
import {
  dehydrate,
  HydrationBoundary,
  QueryClient,
...
export default async function Page({ searchParams }: PageProps) {
  ...
  await Promise.all([
    queryClient.prefetchQuery({
      ...
      queryFn: () => getAllRoleWiseIdeas(params as any),
    }),
    queryClient.prefetchQuery({
      queryKey: ["category"],
